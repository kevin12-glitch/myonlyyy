...
bot = commands.Bot(
    ...
    activity=discord.Activity(
        type=discord.ActivityType.watching, name="Wally"
    ),
    guild = discord.Object(id=281959960363794492) # Change it with your guild id right click on your server and copy the server id and paste it instead of 1229389945626693714
)
...
async def add(ctx, member: discord.Member):
    role = ctx.guild.get_role(1281975022059257867)
...
async def create(ctx, member: discord.Member = None, yoyo: int = None, cx=None, ping_count: int = 0, category: str = "category1", *, x=None):
    ...
    if category.lower() == 'category1':
        category_id = 1281966179191226388  # Category 1 ID
    else:
        category_id = 1281966653843963976  # Category 2 ID
...
bot.run("MTI4MTk2MjMzNTkwMDAxMjYxNA.GW2UTL.pKoYOhUzC7F3DMBuGaF1eWq07QxBmCakj2yClg")
